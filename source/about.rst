...
本手册给用户提供一个 openSUSE® 的整体讲解。主要面向系统管理员和对基本系统管理有初步了解家庭用户。手册方便用户在每天的使用过程中针对每个不同的程序查看手册中相应的章节和内容，同时提供有关高级安装和配置方面的深入描述。

* 高级部署

  了解如何通过远程来部署 openSUSE，以及熟悉复杂的磁盘设置相关内容。

* 软件管理和更新

  了解如何通过 YaST 或者使用命令行程序来安装和删除软件，如何使用一键安装功能，如何保证系统更新。

* 系统管理

  了解如何配置和升级 openSUSE，如何在文本模式下管理系统，以及了解 Linux 管理员需要了解的重要工具。

* 系统

  在这一部分，将会获取到有关您的 Linux 系统的构成，以及对它们之间的交互有更深入的认识。

* 服务

  了解如何配置不同的网络，以及 openSUSE 提供的文件服务。

* 移动化

  对 openSUSE 的移动化有一个基本的介绍，同时对无线计算和电源管理的不同配置有基本的讲述。
